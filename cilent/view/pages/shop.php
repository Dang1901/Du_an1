                    ...
                    <div class="col-lg-3 order-lg-1 order-2">
                        ...
                        <div class="common-sidebar-widget">
                            ...
                            <ul class="sidebar-list">
                               <?php foreach ($dm_cilent as $dm) {
                                extract($dm);
                                $link_dm = "index.php?page=sp&id_loai=".$id;
                                echo '<li><a href="'.$link_dm.'"><i class="fa fa-angle-right"></i>'.$tenloai.'</li> ';
                               } ?>
                        ...
                        <div class="common-sidebar-widget">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="assets/images/hero/banner 8.png" height="250px" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- Single Sidebar End  -->
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                                        ...
                                                        <?php foreach ($sp_cilent as $sp) {
                                                            ...
                                                            <div class="product-content">
                                                                <h3><a href="single-product.html">'.$name.'</a>
                                                                </h3>
                                                                <div class="ratting">
                                                                ...
                                                                <h4 class="price"><span class="new">'.$giasp.'</span><span
